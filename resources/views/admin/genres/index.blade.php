            ...
            <tbody>
                @foreach ($genres as $genre)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.genres.show', $genre->id) }}" class="btn btn-sm btn-info">Show</a>
                            ...
                            <a href="{{ route('admin.genres.delete', $genre->id) }}" class="btn btn-sm btn-danger">Delete</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
